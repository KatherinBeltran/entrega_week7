-- Fase 1: la tabla "fea" heredada de TechStore
-- Una sola tabla para vendedores, clientes, productos y ventas
...
CREATE TABLE ventas_completas (
    ...
    -- Items de venta (multi-valor en una celda — VIOLACIÓN 1FN)
...
-- Observa:
-- "Ana García" aparece 2 veces idéntica.
-- "México" aparece 3 veces.
-- Los productos vienen como string separado por comas.